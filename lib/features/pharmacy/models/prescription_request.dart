  ...
  factory PrescriptionRequest.fromJson(Map<String, dynamic> json) {
    try {
      ...
      return PrescriptionRequest(
        ...
        doctorName: json['doctor']?.toString() ?? json['doctor_name']?.toString() ?? json['doctorName']?.toString() ?? '',
      ...
      return PrescriptionRequest(
        ...
        patientAge: int.tryParse(json['patient_age']?.toString() ?? json['patientAge']?.toString() ?? '0') ?? 0,
        doctorName: json['doctor']?.toString() ?? json['doctor_name']?.toString() ?? json['doctorName']?.toString() ?? 'Unknown Doctor',
