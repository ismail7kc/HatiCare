...
class _PharmacyNotificationsScreenState extends State<PharmacyNotificationsScreen> {
  final List<NotificationItem> notifications = [
    NotificationItem(
      ...
      message: 'You have a new prescription request from Alex Johnson',
    ...
    NotificationItem(
      ...
      message: 'Prescription Rx268920 has been successfully dispensed',
      time: DateTime.now().subtract(const Duration(hours: 2)),
      isRead: false,
      type: NotificationType.dispensed,
    ),
    NotificationItem(
      id: '3',
      title: 'Stock Alert',
      message: 'Amoxicillin 500mg is running low. Current stock: 15 units',
    ...
    NotificationItem(
      id: '4',
      title: 'New Prescription Request',
      message: 'You have a new prescription request from Sarah Williams',
  ...
  IconData _getNotificationIcon(NotificationType type) {
    switch (type) {
      ...
      case NotificationType.dispensed:
