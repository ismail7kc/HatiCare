...
class PharmacyHelpCenterScreen extends StatelessWidget {
  const PharmacyHelpCenterScreen({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            _buildFAQCard(
              ...
              answer:
                  'You can update your pharmacy profile by:\n\n'
            ...
            _buildFAQCard(
              question: 'How do I view prescription history?',
              answer:
                  'To view prescription history:\n\n'
                  '1. Go to the History tab\n'
                  '2. Browse through all processed prescriptions\n'
                  '3. Tap on any prescription to view details\n'
                  '4. Use filters to find specific prescriptions',
            ),
            const SizedBox(height: 12),
