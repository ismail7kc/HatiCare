...
class PharmacyContactSupportScreen extends StatefulWidget {
  const PharmacyContactSupportScreen({super.key});

  @override
  State<PharmacyContactSupportScreen> createState() => _PharmacyContactSupportScreenState();
}

class _PharmacyContactSupportScreenState extends State<PharmacyContactSupportScreen> {
